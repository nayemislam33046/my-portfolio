  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center px-10 md:px-18">
        ...
        <div className="relative" data-aos="fade-right" data-aos-once={true}>
          ...
          <div className="flex items-center gap-4">
            <a
              ...
              className="bg-green-500 text-black font-semibold px-4 py-2 rounded hover:bg-green-400 transition duration-300"
            >
              Contact Me
            </a>
        ...
        <div
          className="flex justify-center relative mt-14 lg:mt-0"
          data-aos="fade-left"
          data-aos-once={true}
        >
          <ParallaxLayer
            ...
            iconName="reactIcon"
            offset={0.1}
            color="absolute -top-3 -left-2 md:left-10 flex justify-center items-center w-10 h-10 backdrop-blur-md"
          />
          <ParallaxLayer
            id={2}
            src={codeIcon}
            iconName="codeIcon"
            offset={0.2}
            color="absolute top-10 right-0 md:right-0 flex justify-center items-center w-10 h-10 backdrop-blur-md"
          />
          <ParallaxLayer
            id={3}
            src={laravelIcon}
            ...
            offset={0.3}
            color="absolute -bottom-5 md:bottom-10 left-0 md:-left-8 lg:left-5 flex justify-center items-center w-10 h-10 backdrop-blur-md"
          />
          ...
          <img
            ...
            loading="lazy"
            className={`relative lg:w-72 lg:h-80 w-56 h-60 object-cover rounded-full transition-all duration-700 ${
